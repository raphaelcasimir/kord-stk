...
double innerkp = -1, innerki = 0, innerkd = 0; // Inner loop PID controller. All should be negative for Inverted Pendulum

double refArmMax = 0.7, refArmMin = -0.7; //in radians
double refVoltMax = 11/0.8, refVoltMin = -11/0.8; //in voltage
...
void calcPID()
{
	...
	double calcedPWM = 512 + refVolt*0.8; // 0.8 motor resistance and PWM sets current.
