...
wb = 2*pi;                           %systemets ?mskede BW i rad/sek
...
estpole = 4*real(-max(abs(real(pc_itae)))); %estimatorpolen= 4* den hurtigste Closed Loop pol
...
Nbar = Nu + K_itae_d*Nx                        %Input reference 
