...
static float Lr=15.0;        // estimator gain
...
static float k1=0.2612;         // statespace feedback matrix K 
static float k2=112.07;
static float k3=595.89;
static float k4=3145.8;
...
float n_bar = 0.8089;           // input reference gain
