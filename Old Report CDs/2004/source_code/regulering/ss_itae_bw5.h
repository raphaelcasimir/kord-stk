...
static float Lr=14.4356;        // estimator gain
...
static float k1=0.0266;         // statespace feedback matrix K 
static float k2=34.9132;
static float k3=230.2126;
static float k4=1332.9;
...
float n_bar = 12.913;           // input reference gain
