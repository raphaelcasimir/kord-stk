...
static float Lr=19.4397;        // estimator gain
...
static float k1=0.05939;         // statespace feedback matrix K 
static float k2=64.687;
static float k3=548.42;
static float k4=3301.5;
...
float n_bar = 53.78;           // input reference gain
