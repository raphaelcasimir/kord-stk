...
static float k1=0.2559;         // statespace feedback matrix K 
static float k2=129.4004;
static float k3=789.8878;
static float k4=4170;
...
float n_bar = 20.2221;           // input reference gain
