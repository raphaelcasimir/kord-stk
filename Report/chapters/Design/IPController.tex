...
\todo[inline,author=Jacob]{Write about simulating this and how the zero and gain is implemented in simulink. Calculate what kp and kd should be to achieve the zero location and gain in simulink.}
