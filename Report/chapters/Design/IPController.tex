...
\todo[inline,author=Jacob]{First remind that the inner loop needs to be faster than the outer loop i.e. lower settling time. Use root locus to design a controller or maybe use PID tuner. Show step response and explain why settling time is fast enough.}
