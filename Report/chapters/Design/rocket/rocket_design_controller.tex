...
\end{equation}
\todo[inline,author=Jacob]{Please check these values!}
...
\todo[inline,author=Jacob]{The second controller is useless so you should clean this up. I didn't read any further than here. I can do the root locus graphs once you are sure about your lead controller pole-zero locations.}
