\chapter{Rocket Analysis}
		...
		\startexplain
			...
			\explain{$\ddot{\theta_b}$ is the angular acceleration of the rocket body}{1}
		...
		\end{equation}
		\startexplain
		\explain{$m_r$ is the mass of the rocket}{\si{\newton\meter}}
		\explain{$l_{Es}$Is the distance from the gimbal to the electronics stage}{\si{\newton}}
		\stopexplain
