\chapter{Rocket Analysis}
		...
		The thruster force $F_t$ will be considered as constant. See the rocket motor test experiment for details (\autoref{chap_appendix:srbtest}). $F_g$ is the rocket's weight. The force of drag is neglected due to the low-speed conditions of the tests, and the absence of air in most real-life scenarios.
