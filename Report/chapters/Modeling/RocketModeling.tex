...
\begin{equation}
 F_drag = \frac{1}{2} \cdot C_d \cdot \rho \cdot A \cdot v^2 \addunit{\newton} \label{eq:F_drag}
\end{equation}
\startexplain
...
\begin{equation}
F_thrust = v_e \cdot \ddot{m} + A (P_e -P_0) \adduunit{\newton} \label{eq:F_thrust}
\end{equation}
\startexplain
...
\begin{equation}
P_0 = p_0 + 0.5 \cdot \rho \cdot(v_o)^2 \adduunit{\kilo\gram\per\meter\per\second\squared} \label{eq:P_o}
\end{equation}
\startexplain
...
\begin{equation}
P_e = p_o + 0.5 \cdot \rho \cdot(v_e)^2 \adduunit{\kilo\gram\per\meter\per\second\squared} \label{eq:P_e}
\end{equation}
\startexplain
