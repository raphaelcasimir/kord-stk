...
%		\end{equation}
		...
		The transfer function of the servo will be needed, which is first order system. Its time constant is determined in \todo[inline, author=Raph]{Add servo test experiment}
