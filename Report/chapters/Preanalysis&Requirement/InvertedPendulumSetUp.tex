...
\begin{subequations}
\begin{flalign}
J_s\ddot{\theta}_s&=\frac{l_s}{2}F_p-b_{as}\dot{\theta}_{as} \\ 
...
\begin{subequations}
\begin{flalign}
& s^2\Theta_s(s)=\frac{3}{2l_s}\left(-s^2l_a\Theta_a(s)+g\Theta_s(s)\right)-s\frac{3b_{as}}{M_sl_s^2}\Theta_s(s)+s\frac{3b_{as}}{M_sl_s^2}\Theta_a(s)  \\ 
& \Theta_s(s)\left(s^2+\frac{3b_{as}}{M_sl_s^2}s-\frac{3g}{2l_s}\right)=\Theta_a(s)\left(-\frac{3l_a}{2l_s}s^2+\frac{3b_{as}}{M_sl_s^2}s\right)  \\ 
& \frac{\Theta_s(s)}{\Theta_a(s)}=-\frac{\frac{3l_a}{2l_s}s^2-\frac{3b_{as}}{M_sl_s^2}s}{s^2+\frac{3b_{as}}{M_sl_s^2}s-\frac{3g}{2l_s}} \label{eq:tfArmStick} 
\end{flalign} 
\end{subequations}

\todo[inline]{Explain how the zeros and poles relate to the actual system } 
