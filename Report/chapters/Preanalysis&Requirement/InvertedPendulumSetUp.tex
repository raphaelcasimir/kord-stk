...
\startexplain
	...
	\explain{$\ddot{\theta}_s$ is the angular acceleration of the stick}{\si{\degree\per\square\second}}
	...
	\explain{$\dot{\theta}_{as}$ is the difference in angular velocity between the arm and the stick ($\dot{\theta}_s-\dot{\theta}_a$)}{\si{\degree\per\second}}
\stopexplain
