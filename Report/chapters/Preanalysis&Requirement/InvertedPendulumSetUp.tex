...
& J_s\ddot{\theta}_s = \frac{l_s}{2}M_s \Big( -l_a\ddot{\theta}_s\left(\cos(\theta_a)\cos(\theta_s)+\sin(\theta_a)\sin(\theta_s)\right) && \notag \\
...
\begin{flalign}
& J_s\ddot{\theta}_s = \frac{l_s}{2}M_s \Big( -l_a\ddot{\theta}_s \cos(\theta_a-\theta_s)+l_a\dot{\theta}_a^2 \sin(\theta_a-\theta_s)  &&& \notag \\
