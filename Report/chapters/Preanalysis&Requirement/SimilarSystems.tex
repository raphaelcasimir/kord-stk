...
\todo{Decision needs to be made, considering if this chapter should lead to modelling both the inverse pendulum and a the rocket, and conclude that controlling them is the same - Mathias}
