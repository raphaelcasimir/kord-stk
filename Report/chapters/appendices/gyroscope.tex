...
The code is written on the Arduino code Software. The Inter-Integreted Circuit (I2C) is used to simplify the code for the testing. The code is found from in an online-tutorial.
...
Some error can however appear in the gyroscope measurments but are consided as negligeable.

	\section{Conclusion}
	
The values of Y when the gyroscope is placed parrarel to the rocket body are not usable. When the gyroscope is perpendicular to the rocket body, the measurments can be modified to mesure the tilting of the rocket. Thus the gyroscope will be placed perpendiculary to the rocket body.