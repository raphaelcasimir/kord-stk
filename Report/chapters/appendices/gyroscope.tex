...
\begin{table}[htbp]
	...
	\begin{tabularx}{\textwidth}{lX}
		...
		& breadboard &  &  \\
		& Controller & Arduino & Nano v3.0 \\ \rowcolor{lightGrey}
...
The code is written on the Arduino code Software. The Inter-Integreted Circuit (I2C) is used to simplify the code for the testing. The code is adapted from an online tutorial. The output is the angular speed. In orther to 
...
The breadboard is moved and rotated in the three different axis in order to test the pitch and roll. The yawn is not needed for the purpose of the project.
