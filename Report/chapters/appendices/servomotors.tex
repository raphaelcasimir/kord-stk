...
The error comes from measure errors and from the fact the servomotors need to lift a weight.
 ...
 \end{subequations}
 \startexplain
\explain{$ t_{constant}$ is the time constant of the servomotors}{\si{\second}}
...
The image analysis presents errors. In flight the desired range of angle movement of the servomotors is inferior to $-30$ to $30$ degrees. The servomotors are considered precise enough for the project. The time constant of the servomotors is $0.084$.
