...
\startexplain
\explain{$\theta_a$ is the angle of the arm.}{\si{\radian}}
\explain{$\theta_s$ is the angle of the stick.}{\si{\radian}}
\explain{$x_{\alpha}$ is the distance to initial upright position.}{\si{\meter}}
\explain{$Ref_{x_\alpha}$ is the reference distance error to initial upwards position.}{\si{\meter}}
\explain{$x_{\alpha}Err$ is the distance error from initial upright position.}{\si{\meter}}
\explain{$Ref_{\theta_a}$ is the reference angle of the arm.}{\si{\radian}}
\explain{$\theta_{a}Err$ is the angle error of the arm.}{\si{\radian}}
\explain{$Ref_{\omega_m}$ is the reference velocity of the motor.}{\si{\radian\per\second}}
\explain{$\omega_{m}Err$ is the velocity error of the motor.}{\si{\radian\per\second}}
\stopexplain
