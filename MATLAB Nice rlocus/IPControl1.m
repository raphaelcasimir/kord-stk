...
h=rlocusplot(Gre*(s+6)); %Gre*(s+6)
p=getoptions(h);
p.ylabel.FontSize = 14;
p.xlabel.FontSize = 14;
p.title.FontSize = 16;
p.title.String = 'Root Locus of Arms Angle to Sticks Position';
...
p.xlabel.FontSize = 14;
p.title.FontSize = 16;
p.title.String = 'Root Locus of Inner Loop with a Zero Added';
p.ticklabel.FontSize = 12;
p.xlim=[-60 8];
p.ylim=[-25 25];
setoptions(h,p);
